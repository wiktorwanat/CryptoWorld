...
public class UserControllerTest {
    ...
    public void getUserFavouriteCryptocurrenciesListTest__withServerError_shouldReturnEmptyResponseWith404Status() throws Exception{
        given(this.userService.getUserFavouriteCryptocurrencies(Mockito.any(String.class))).willAnswer( invocation -> { throw new Exception(); });
    ...
    public void addCryptocurrencyToUserFavouriteListTest__withServerError_shouldReturnEmptyResponseWith404Status() throws Exception{
        willAnswer( invocation -> { throw new Exception(); }).willDoNothing().given(this.userService).addCryptocurrencyToFavourite(Mockito.any(String.class),Mockito.any(String.class));        
    ...
    public void removeCryptocurrencyFromUserFavouriteListTest__withServerError_shouldReturnEmptyResponseWith404Status() throws Exception{
        willAnswer( invocation -> { throw new Exception(); }).willDoNothing().given(this.userService).removeCryptocurrencyFromFavourite(Mockito.any(String.class),Mockito.any(String.class));        
