...
//dodaj image po tytule

    public static String getReportEmailContent(Cryptocurrency cryptocurrency, Report report) {
        if (cryptocurrency !=null) {
            reportMailContent = String.format(reportMailContent, cryptocurrency.getName(),cryptocurrency.getActualPrice(),cryptocurrency.getMarketCap(),
                    ...
                    report.RSI,report.MA,report.SMA);
        }
